...
solution <- c(0.80254630, 0.82842399, 0.13943825, 0.32911782, 0.80899805, 0.27442505, 0.13613248, 0.10763776,
               ...
               0.77725946, 0.15132663, 0.97976923)

# get length of solution
len <- length(solution)
expect_equal(len, 35)

# get values from vector that belong to permutation
permutation <- solution[(len - length(features) + 1):len]
expect_equal(permutation, c(0.8973746, 0.1989501, 0.8979509, 0.8269342, 0.1714016, 0.2513016, 0.7772595, 0.1513266, 0.9797692))

# remove permutation part from the vector
