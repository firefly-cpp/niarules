...
/// @brief Represents a node in the radial layout.
///
...
struct Node {
    ...
    double radius; ///< Radial distance from the center of the plot.
...
/// @brief Represents an edge between two nodes in the radial layout.
///
...
/// @brief Entry point to build radial plots from association rules.
///
...
///
/// @param rules Vector of Rule objects representing association rules.
/// @param[out] edges Vector to be populated with edges of the radial plot.
/// @param[out] nodes Vector to be populated with nodes of the radial plot.
